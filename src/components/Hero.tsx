  ...
  return (
    <section className="pt-28 pb-16 md:pt-40 md:pb-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 opacity-20">
        <div className="absolute top-1/4 left-1/6 w-64 h-64 rounded-full bg-xenoblue/20 filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/6 w-80 h-80 rounded-full bg-xenoblue/10 filter blur-3xl"></div>
      </div>
      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row items-center gap-12 md:gap-8">
          ...
          <div className={`max-w-2xl transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="inline-block px-3 py-1 mb-6 bg-xenoblue/10 text-xenoblue rounded-full text-sm font-medium">
              High-Performance Virtual Private Servers
            </div>
            <h1 className="mb-6 font-bold text-xenoblack">
              Powerful VPS Hosting for Your Digital <span className="text-xenoblue">Infrastructure</span>
            </h1>
            <p className="text-lg md:text-xl text-xenoblack/70 mb-8 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#contact" className="px-6 py-3 rounded-lg border border-xenoblue/30 text-xenoblue font-medium hover:bg-xenoblue/5 transition-colors">
                Contact Us
              </a>
            </div>
          ...
          <div className={`relative flex-1 transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
            <div className="relative w-full aspect-square max-w-md mx-auto">
              ...
              <div className="absolute inset-0 glass-card rounded-3xl shadow-xl overflow-hidden border border-white/40">
